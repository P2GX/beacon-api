...
async def list_runs(
    ...
    Returns:
        BeaconResultsetsResponse with run records
    ...
    try:
        ...
        runs = await service.query(request_body)

        requested_schemas = schema_for_entity("run")
        ...
        response = build_resultset_response(entity_type="run", results=[])
